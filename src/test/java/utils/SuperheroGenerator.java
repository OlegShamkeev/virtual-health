...
public class SuperheroGenerator {
    ...
    public static SuperheroPojo generateSuperhero(Faker faker) {
        ...
        superhero.setBirthDate(faker.date().past(12000, TimeUnit.DAYS).toInstant().atZone(ZoneId.systemDefault()).toLocalDate().toString());
        ...
        superhero.setPhone(faker.numerify("##########"));
        return superhero;
    }
}
